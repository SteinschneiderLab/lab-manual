...
If you are also interested in using Anaconda for environment management in R, see [here](https://docs.anaconda.com/navigator/tutorials/create-r-environment/).
